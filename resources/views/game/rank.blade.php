<div id="Result" class="glass-effect center">
    ...
    <div>
        <form action="/create" method="post">
            @csrf
            <div>
                <p>Bravo, tu es sorti en XXminXX, tu peux enregistrer ton score en remplissant ton pseudo dans le formulaire. Merci d'avoir joué à notre jeu, nous espérons qu'il t'a plu !</p>
